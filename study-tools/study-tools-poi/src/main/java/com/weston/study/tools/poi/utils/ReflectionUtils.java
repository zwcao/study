package com.weston.study.tools.poi.utils;
...
import com.weston.study.tools.poi.exception.ReflectionException;
...
public class ReflectionUtils {
	...
	/**
	 * 循环向基类查找指定的field, 获取对象的DeclaredField, 并强制设置为可访问. 如向基类查找Object仍无法找到, 返回null.
	 */
	...
	/**
	 * 循环向基类查找 获取对象的DeclaredMethod,并强制设置为可访问. 如向上转型到Object仍无法找到, 返回null.
	 * <p>
	 ...
	 * UserRepository extends HibernateRepositry<User>
	 *
	 * @param clazz
	...
	public static Class<?> getInterfaceGenericType(final String className, final Class<?> interfaceClazz,
			final int index) {
		try {
